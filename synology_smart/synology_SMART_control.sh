...
##################################################################################################################
	...
	then
		...
		##################################################################################################################
		disk_list1=$(fdisk -l | grep "Disk /dev/sata*[0-9]:" 2>/dev/null)   #some systems have drives listed as /stata1, /sata2 etc
		disk_list2=$(fdisk -l | grep "Disk /dev/sd" 2>/dev/null)			 #some systems have drives listed as /sda, /sdb etc
